...
class Environment(object):
    ...
    def create_agent(self, agent_class, arguments =(0,0,0) ,*args, **kwargs):
        agent = agent_class(self, *args, **kwargs)
        if agent_class != DummyAgent:
            agent.setArgument(arguments)
    ...
    def act(self, agent, action):
        ...
        if agent is self.primary_agent:
            if state['location'] == state['destination']:
                ...
                print "Environment.act(): Primary agent has reached destination! + success number:  "
