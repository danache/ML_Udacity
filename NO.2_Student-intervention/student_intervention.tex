...
the class, \texttt{grad\_rate}, in percent (\%).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{} TODO: Calculate number of students}
...
target columns to see if any features are non-numeric.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}52}]:} \PY{c+c1}{\PYZsh{} Extract feature columns}
...
perform the preprocessing routine discussed in this section.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}53}]:} \PY{k}{def} \PY{n+nf}{preprocess\PYZus{}features}\PY{p}{(}\PY{n}{X}\PY{p}{)}\PY{p}{:}
...
\texttt{y\_test}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{} TODO: Import any additional functionality you may need here}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
        ...
        <ipython-input-4-0c27af2e6258> in <module>()
          1 \# TODO: Import any additional functionality you may need here
          2 from sklearn.cross\_validation import train\_test\_split
    ----> 3 import Image
          4 image = Image.open("SVM\_2.PNG")
          5 image.show()
...
separately.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}55}]:} \PY{k}{def} \PY{n+nf}{train\PYZus{}classifier}\PY{p}{(}\PY{n}{clf}\PY{p}{,} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{)}\PY{p}{:}
...
which can be used to store your results.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}28}]:} \PY{c+c1}{\PYZsh{} TODO: Import the three supervised learning models from sklearn}
         ...
         \PY{n}{clf\PYZus{}C} \PY{o}{=} \PY{n}{KNeighborsClassifier}\PY{p}{(}\PY{n}{n\PYZus{}neighbors}\PY{o}{=}\PY{l+m+mi}{3}\PY{p}{)}
         ...
         \PY{n}{train\PYZus{}predict}\PY{p}{(}\PY{n}{clf\PYZus{}A}\PY{p}{,} \PY{n}{X\PYZus{}train\PYZus{}100}\PY{p}{,} \PY{n}{y\PYZus{}train\PYZus{}100}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{train\PYZus{}predict}\PY{p}{(}\PY{n}{clf\PYZus{}B}\PY{p}{,} \PY{n}{X\PYZus{}train\PYZus{}100}\PY{p}{,} \PY{n}{y\PYZus{}train\PYZus{}100}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{train\PYZus{}predict}\PY{p}{(}\PY{n}{clf\PYZus{}C}\PY{p}{,} \PY{n}{X\PYZus{}train\PYZus{}100}\PY{p}{,} \PY{n}{y\PYZus{}train\PYZus{}100}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{train\PYZus{}predict}\PY{p}{(}\PY{n}{clf\PYZus{}A}\PY{p}{,} \PY{n}{X\PYZus{}train\PYZus{}200}\PY{p}{,} \PY{n}{y\PYZus{}train\PYZus{}200}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{train\PYZus{}predict}\PY{p}{(}\PY{n}{clf\PYZus{}B}\PY{p}{,} \PY{n}{X\PYZus{}train\PYZus{}200}\PY{p}{,} \PY{n}{y\PYZus{}train\PYZus{}200}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{train\PYZus{}predict}\PY{p}{(}\PY{n}{clf\PYZus{}C}\PY{p}{,} \PY{n}{X\PYZus{}train\PYZus{}200}\PY{p}{,} \PY{n}{y\PYZus{}train\PYZus{}200}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{train\PYZus{}predict}\PY{p}{(}\PY{n}{clf\PYZus{}A}\PY{p}{,} \PY{n}{X\PYZus{}train\PYZus{}300}\PY{p}{,} \PY{n}{y\PYZus{}train\PYZus{}300}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{train\PYZus{}predict}\PY{p}{(}\PY{n}{clf\PYZus{}B}\PY{p}{,} \PY{n}{X\PYZus{}train\PYZus{}300}\PY{p}{,} \PY{n}{y\PYZus{}train\PYZus{}300}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{train\PYZus{}predict}\PY{p}{(}\PY{n}{clf\PYZus{}C}\PY{p}{,} \PY{n}{X\PYZus{}train\PYZus{}300}\PY{p}{,} \PY{n}{y\PYZus{}train\PYZus{}300}\PY{p}{,} \PY{n}{X\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{)}
\end{Verbatim}
