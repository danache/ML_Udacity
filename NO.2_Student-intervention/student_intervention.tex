...
the class, \texttt{grad\_rate}, in percent (\%).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}51}]:} \PY{c+c1}{\PYZsh{} TODO: Calculate number of students}
         \PY{n}{n\PYZus{}students} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{student\PYZus{}data}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} TODO: Calculate number of features}
         \PY{n}{n\PYZus{}features} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{student\PYZus{}data}\PY{o}{.}\PY{n}{columns}\PY{p}{)}
...
\texttt{y\_test}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}54}]:} \PY{c+c1}{\PYZsh{} TODO: Import any additional functionality you may need here}
